...
@section('container')
<a href="/posts" class="text-decoration-none text-dark"><h1 class="mb-3 text-center">{{ $title }}</h1></a>
...
<div class="card mb-3">
   @if ($posts[0]->image)
          ...
          @else
            <img src="https://source.unsplash.com/960x320?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
          @endif
